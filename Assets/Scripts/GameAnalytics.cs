...
public class GameAnalytics : NetworkBehaviour
{
    ...
    public string M2_TotalDeDinheiroGasto = "[0;";
    ...
    void Update()
    {
        ...
        {
            CmdUpdateDinheiroTotalGasto(1.0f);
        }
    }
    ...
    {
        string all = "{";
        all += (M2_TotalDeDinheiroGasto + "]");
        all += "}";
        System.IO.File.WriteAllText("D:/EJW/MatchAnalytics.txt", all);
    }
